...
public class FiguraL : CartaFigura
{
    ...
    protected override List<(int fila, int columna)[]> Patrones => new List<(int fila, int columna)[]>
    {
        ...
        new (int fila, int columna)[] { (0, 0), (0, 1), (0, 2), (1, 0) }, // horizontal, pie abajo a la izquierda
        new (int fila, int columna)[] { (0, 0), (0, 1), (1, 1), (2, 1) }, // vertical, pie arriba a la izquierda
        new (int fila, int columna)[] { (0, 2), (1, 0), (1, 1), (1, 2) }  // horizontal, pie arriba a la derecha
    };
}