...
public class FiguraTIzq : CartaFigura
{
    ...
    protected override List<(int fila, int columna)[]> Patrones => new List<(int fila, int columna)[]>
    {
        ...
        new (int fila, int columna)[] { (0, 1), (1, 0), (1, 1), (1, 2), (1, 3) },
        new (int fila, int columna)[] { (0, 0), (1, 0), (1, 1), (2, 0), (3, 0) },
        new (int fila, int columna)[] { (0, 0), (0, 1), (0, 2), (0, 3), (1, 2) }
    };
}